...
import JobRecommender from "./Component/JobRecommend/JobRecommend";
import FundraisingPage from "./Component/Fund/FundRaising";
          ...
          {isAdminPage ? (
            ...
            <>
              <Routes>
                ...
                <Route path="/Job-Recommend" element={<JobRecommender/>}/>
                <Route path="/Fund-Raising" element={<FundraisingPage/>}/>
              </Routes>
              <Chatbot />
            </>
          )}
