...
const AddEvent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEvent({ title: "", description: "", date: "", time: "", meetingLink: "" });
    } catch (error) {
  ...
  return (
    <div className="add-event-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="meetingLink" placeholder="Event Link" value={event.meetingLink} onChange={handleChange} required />
